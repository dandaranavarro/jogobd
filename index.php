...
<body>
	<div id='tudo'>
		...
		<div id = 'menu'> 
				...
				<form method = "LINK" action = "#"> <INPUT TYPE="submit" VALUE="OPÇÕES" class = 'botao3d'> </FORM> 
				<form method = "LINK" action = "#"> <INPUT TYPE="submit" VALUE="CRÉDITOS" class = 'botao3d'> </FORM>
				<form method = "LINK" action = "#"> <INPUT TYPE="submit" VALUE="SAIR DO JOGO" class = 'botao3d'> </FORM>
		</div>
		</div>
	</div>
</body>
